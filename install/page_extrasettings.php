...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach($wizard->configs['email'] as $setting => $values)
    {
        $_SESSION['constants']['email'][$setting] = $_POST[$setting];
...
?>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <?php
            foreach($wizard->configs['email'] as $setting => $default)
            {?>
                <div class="form-group">
                <label for="<?php echo $setting; ?>"><?php echo constant("API_EMAIL_".strtoupper($setting) . "_LABEL"); ?></label>
                <div class="xoform-help alert alert-info"><?php echo constant("API_EMAIL_".strtoupper($setting) . "_HELP"); ?></div>
