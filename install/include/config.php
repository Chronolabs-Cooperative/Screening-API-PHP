...
// Email Service Resource data files default paths
$configs['email'] = array(
    'imap_server' => 'imap.'.$_SERVER["HTTP_HOST"],
    'smtp_server'  => 'smtp.'.$_SERVER["HTTP_HOST"],
    'username' => 'screening@'.$_SERVER["HTTP_HOST"],
    'password' => '',
    'reply' => 'screening@'.$_SERVER["HTTP_HOST"],
    'days' => mt_rand(3,9),
    );
